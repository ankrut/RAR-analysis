function fh = radius_compactness(AX,formatX,AY,formatY,varargin)
DIM = struct(...
	'width',	11.1125*4/3,...
	'height',	11.1125,...
...
lib.view.plot.xlabel(AX,formatX);
lib.view.plot.ylabel(AY,formatY);
