function main
T		= load('export/CacheWithoutCutoffAnalysisRhop.mat');
STYLE	= lib.require(@configs.style_analysis);
fh		= view.without_cutoff.rhop.analysis_raw.figure();
...
lib.view.latex.figure(...
	'path',		'export/without-cutoff/rhop-analysis-raw/',...
	'figure',	fh,...
	'label',	'fig:analysis:without-cutoff:plateau-density:raw',...
	'caption',	fileread('+view/+without_cutoff/+rhop/+analysis_raw/caption.txt') ...
);