...
P		= load('export/TblWithCutoffAnalysisRHO0RHOp.mat');
...
% cache data
T = P.RHO0RHOp.map(@(vm) fMap(lib.model.tov.rar.profile('model', vm)));

% save
lib.save('export/CacheWithCutoffAnalysisRHO0RHOp.mat',struct('RHO0RHOp',T));