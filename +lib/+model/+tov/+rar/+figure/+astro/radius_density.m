...
% define axis
AX = lib.module.ProfileAxis(MAP.radius,		SCALE.astro.radius);
AY = lib.module.ProfileAxis(MAP.density,	SCALE.astro.density);

ax = lib.module.figure.axes(...
	'xlabel', sprintf('$%s\\quad[%s]$',AX.mapmodel.var,AX.scalelib.model.unit),...
	'ylabel', sprintf('$%s\\quad[%s]$',AY.mapmodel.var,AY.scalelib.model.unit) ...
);
